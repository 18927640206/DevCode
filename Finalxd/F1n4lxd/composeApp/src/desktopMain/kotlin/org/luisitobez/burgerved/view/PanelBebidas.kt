...
import finalxd.composeapp.generated.resources.Efectivo
...
fun PanelBebidas(
    ...
    Button(
        ...
        Row(
            ...
            Image(
                painter = painterResource(resource = Res.drawable.Efectivo), //QUITE SODA porque no lo encontre en el archivo. Me marcaba error
